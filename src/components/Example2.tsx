...
const Example2: React.FC = () => {
  ...
  useEffect(() => {
    if (logoRef.current) {
      ...
      if (path) {
        ...
        // Morph animation - scale up and skew
        .to(
          logoRef.current,
          {
            scale: 1.2,
        ...
        // Morph back - scale down and unskew
        .to(
          logoRef.current,
          {
            scale: 1,
  ...
  return (
    <div className="example2-container">
      <div className="animation-title">Morphing Animation</div>
      <div className="animation-info">
        <p>Animation Type: Morphing</p>
        <p>Technique: Scale & Skew</p>
        <p>Library: GSAP Timeline</p>
      </div>
      <div className="animation-wrapper">
        <div ref={logoRef} className="example2-logo">
